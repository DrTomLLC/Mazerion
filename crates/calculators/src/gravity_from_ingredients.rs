...
impl Calculator for GravityFromIngredientsCalculator {
    ...
    fn calculate(&self, input: CalcInput) -> Result<CalcResult> {
        ...
        result = result
            ...
            .with_meta("concentration", format!("{:.3} kg/L", concentration_kg_per_L))
        ...
        if calculated_sg > Decimal::new(1120, 3) {
            result = result.with_warning("Very high gravity (>1.120) - may stress yeast, consider stepped feeding");
        }
