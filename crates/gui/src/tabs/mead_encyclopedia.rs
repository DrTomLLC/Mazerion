//! 🔒 MEAD ENCYCLOPEDIA - FROZEN - DO NOT MODIFY
//! Complete mead styles reference guide
//! This file is PERMANENTLY FROZEN and must NEVER be changed

use crate::MazerionApp;
use eframe::egui::{self, Color32, RichText};

/// Render the complete mead encyclopedia
/// DO NOT MODIFY THIS FUNCTION
pub fn render(app: &MazerionApp, ui: &mut egui::Ui) {
    ...
    egui::CollapsingHeader::new(RichText::new("📜 Traditional Meads (Show Meads)")
        ...
        .show(ui, |ui| {
            ...
            egui::CollapsingHeader::new(RichText::new("  🌍 Regional Traditional Variants")
                .size(18.0)
                .color(c.honey_gold))
                .default_open(false)
                .show(ui, |ui| {
    ...
    egui::CollapsingHeader::new(RichText::new("⚡ Specialty & Hybrid Meads")
        ...
        .show(ui, |ui| {
            ...
            render_style(ui, c, StyleInfo {
                ...
                tips: "• Use REAL maple syrup only (Grade A or B)\n• Typical ratio: 70% honey, 30% maple by fermentables\n• Can go as low as 50/50 for strong maple character\n• Semi-sweet finish (1.012-1.018) most popular\n• Carbonation recommended - 2.5-3 volumes CO₂\n• Fall/winter seasonal release\n• Expensive but worth it - no substitutes for real maple",
                food_pairings: "Cheese: Aged cheddar, smoked Gouda, aged Gruyère.\nProtein: Maple-glazed ham, bacon-wrapped anything, roasted pork.\nDessert: Maple walnut pie, pecan pie, maple ice cream, bread pudding.\nCuisine: Brunch, Thanksgiving, Canadian cuisine, New England fall fare.\nSpecialty: Pancakes, waffles, French toast, autumn harvest meals.",
            });
            ...
            render_style(ui, c, StyleInfo {
                ...
                description: "Honey is caramelized before fermentation. Creates toffee, caramel, toasted marshmallow flavors. Darker color. Complex Maillard reaction products. Sweet finish required. Challenging but rewarding.",
                characteristics: "Color: Deep amber to dark brown\nClarity: Brilliant\nAroma: Caramel, toffee, toasted honey, burnt sugar\nFlavor: Rich caramel with honey sweetness\nMouthfeel: Full body, smooth, dessert-like",
                aging: "12-24 months. Caramel notes mellow and integrate.",
                tips: "• Caramelize honey CAREFULLY - can burn quickly\n• Light bochet: 5-10 min boiling (blonde caramel)\n• Medium: 15-20 min (amber caramel)\n• Dark: 25-30 min (dark caramel, close to burning)\n• MUST backsweeten - dry bochet tastes burnt\n• Target FG: 1.020-1.028\n• Excellent with vanilla, cinnamon, oak aging\n• Watch honey closely - from perfect to burnt in 30 seconds",
                food_pairings: "Cheese: Aged Gouda, aged cheddar, Parmigiano-Reggiano.\nDessert: Crème brûlée, toffee pudding, butterscotch desserts, caramel tart.\nProtein: Caramel-glazed pork, BBQ ribs, braised short ribs.\nSpecialty: After-dinner sipping, pairs with cigars, drizzle over ice cream.\nOccasion: Dessert replacement, contemplative evening drink.",
            });
        });
...
// Helper structs and rendering functions
struct StyleInfo {
    name: &'static str,
    fg_range: &'static str,
