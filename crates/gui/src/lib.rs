...
use std::str::FromStr;
use mazerion_core::traits::{get_calculator, list_calculators};
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            egui::ComboBox::from_label("Calculator")
                ...
                .show_ui(ui, |ui| {
                    for calc_id in mazerion_core::traits::list_calculators() {
...
impl MazerionApp {
    ...
    fn calc_brix_to_sg(&self) -> mazerion_core::Result<String> {
        let calc = get_calculator("brix_to_sg")
            .ok_or_else(|| mazerion_core::Error::Calculation("Calculator not found".into()))?;
    ...
    fn calc_sg_correction(&self) -> mazerion_core::Result<String> {
        let calc = get_calculator("sg_correction")
            .ok_or_else(|| mazerion_core::Error::Calculation("Calculator not found".into()))?;
