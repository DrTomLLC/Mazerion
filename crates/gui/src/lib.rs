...
pub struct MazerionApp {
    ...
    pub og: String, pub fg: String, pub brix: String, pub current_vol: String,
    pub current_abv: String, pub target_abv: String, pub vol1: String, pub abv1: String,
    pub vol2: String, pub abv2: String, pub orig_brix: String, pub curr_brix: String,
    pub sg: String, pub temp: String, pub volume: String, pub target_abv_brew: String,
    pub yn_requirement: String, pub carb_temp: String, pub target_co2: String,
    pub carb_method: String, pub sugar_type: String, pub sweet_vol: String,
    pub current_sg: String, pub target_sg: String, pub sweetener: String,
    pub sulfite_vol: String, pub ph: String, pub target_so2: String, pub acid_vol: String,
    pub current_ph: String, pub target_ph_acid: String, pub acid_type: String,
}

impl Default for MazerionApp {
    fn default() -> Self {
        Self {
            state: AppState::default(), result: None, warnings: Vec::new(),
            metadata: Vec::new(), og: "1.090".into(), fg: "1.010".into(),
            brix: "15.0".into(), current_vol: "20".into(), current_abv: "14".into(),
            target_abv: "10".into(), vol1: "10".into(), abv1: "14".into(),
            vol2: "10".into(), abv2: "10".into(), orig_brix: "22.0".into(),
            curr_brix: "8.0".into(), sg: "1.050".into(), temp: "20".into(),
            volume: "19".into(), target_abv_brew: "14".into(),
            yn_requirement: "medium".into(), carb_temp: "20".into(),
            target_co2: "2.5".into(), carb_method: "priming".into(),
            sugar_type: "table_sugar".into(), sweet_vol: "19".into(),
            current_sg: "1.000".into(), target_sg: "1.010".into(),
            sweetener: "honey".into(), sulfite_vol: "19".into(), ph: "3.5".into(),
            target_so2: "30".into(), acid_vol: "19".into(), current_ph: "3.8".into(),
            target_ph_acid: "3.4".into(), acid_type: "tartaric".into(),
        }
    }
}
        ...
        egui::CentralPanel::default().frame(egui::Frame::central_panel(&ctx.style()).fill(bg)).show(ctx, |ui| {
            ...
            egui::ScrollArea::vertical().show(ui, |ui| {
                ...
                if let Some(ref result) = self.result {
                    ui.add_space(15.0);
                    egui::Frame::new().fill(panel_bg)
                        .stroke(egui::Stroke::new(3.0, Color32::from_rgb(0, 150, 0)))
                        .corner_radius(CornerRadius::same(8)).inner_margin(15.0)
                        .show(ui, |ui| {
                ...
                if !self.warnings.is_empty() {
                    ...
                    egui::Frame::new().fill(panel_bg)
                        ...
                        .corner_radius(CornerRadius::same(6)).inner_margin(12.0)
                        .show(ui, |ui| {
...
pub fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let options = eframe::NativeOptions {
        viewport: egui::ViewportBuilder::default()
            .with_inner_size([1000.0, 700.0]).with_min_inner_size([800.0, 600.0]),
        ..Default::default()
    };
    eframe::run_native("Mazerion", options, Box::new(|_| Ok(Box::new(MazerionApp::default()))))?;
    Ok(())
}
...
pub fn calculate_button(ui: &mut egui::Ui, text: &str) -> bool {
    ui.add(egui::Button::new(RichText::new(text).color(Color32::WHITE).size(16.0).strong())
        .fill(state::colors::FOREST_GREEN).min_size(egui::Vec2::new(200.0, 40.0))).clicked()
}